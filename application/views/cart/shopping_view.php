<html>
	...
	<body>
		...
		<img height="100px" width="980px" src="<?php echo base_url(); ?>images/head_cart.jpg"/>
		</div>
		<div id="cart" >
		<div id = "heading">
		<h2 align="center">Products on Your Shopping Cart</h2><a href="home/logout"><img class="img_align" height="20px" width="100px" src="<?php echo base_url(); ?>images/logout.png"/></a>
		</div>
		...
		<?php
		// cancle image.
		$path = "<img src='/cart/images/cart_cross.jpg'  width='25px' height='20px'>";
		...
		<div id='product_div'>
		<div id='image_div'>
		<img class="img_size" src="<?php echo base_url() . $product['picture'] ?>" />
		</div>
		<div id='info_product'>
